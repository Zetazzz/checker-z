...
export interface CheckerzQueryAllStoredGameResponse {
  storedGame?: CheckerzStoredGame[];
...
export interface CheckerzQueryGetStoredGameResponse {
  storedGame?: CheckerzStoredGame;
}
...
export interface CheckerzStoredGame {
  index?: string;
  board?: string;
  turn?: string;
  black?: string;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/zetazzz/checker-z/checkerz/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckerzQueryAllStoredGameResponse, RpcStatus>({
      path: `/zetazzz/checker-z/checkerz/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/zetazzz/checker-z/checkerz/stored_game/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<CheckerzQueryGetStoredGameResponse, RpcStatus>({
      path: `/zetazzz/checker-z/checkerz/stored_game/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
